...
//    String BASE_URL = "http://logistic.blindsandbeyond.be/admin/index.php/ApiController/";
//    String IMAGE_URL = "http://logistic.blindsandbeyond.be/admin/image/";
...
//    */
    ...
    Pattern MOBILE_NUMBER_PATTERN = Pattern.compile("^[0-9]{10,11}$");
